...
const Hero = () => {
  ...
  return (
    ...
    <div className='px-5 bg-[url(https://images.pexels.com/photos/1639562/pexels-photo-1639562.jpeg?auto=compress&cs=tinysrgb&w=3000)] bg-contain lg:bg-cover relative bg-no-repeat w-screen pt-[160px] text-white h-screen '>
